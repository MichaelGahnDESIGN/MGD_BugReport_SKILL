...
| `/graphify` | Um einen Fehler einzugrenzen, hilft die Karte: Wer ruft die betroffene Stelle auf? | [graphify](https://github.com/Graphify-Labs/graphify) |
| `/autopilot` | Ein vollständiges Feedback-System aufzubauen zieht sich über viele Schritte. | [MGD_Autopilot_SKILL](https://github.com/MichaelGahnDESIGN/MGD_Autopilot_SKILL) |
